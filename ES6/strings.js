...
// split: divide la cadena en base a un caracter definido por nosotros
...
// Join: unir los elementos de un array en una cadena por un caracter definido por nosotros
...
console.log(texto);
console.log( texto.replace( palabra,"peor" ) );

//replaceall no funciona en node solo en el navegador

console.log( texto.split(palabra).join("peor") );
